...
do
    ...
    ###################################
    ### Parallel version
    for ID in ${meses[*]}; do echo $ID; done  | xargs -I{} --max-procs 9 bash -c "
      echo $fore {};
      Rscript /home/josegarcia/obsPronostico/ActualizacionMensual/modelo_autoTasaCambioMax1Mensual.r $fore {}"
